 ...
 * No HTTP calls are made â€” the API methods detect the test site/series IDs
 * and delegate here.
 *
 * <p>The site provides four time series:</p>
 * <ul>
 *   <li>Daily discharge (param 00060, stat 00003) â€” value = day of month</li>
 *   <li>Continuous gage height (param 00065, Instantaneous) â€” value = hour of day</li>
 *   <li>Continuous water temperature, Left Bank (param 00010, Instantaneous) â€” value = hour of day</li>
 *   <li>Continuous water temperature, Right Bank (param 00010, Instantaneous) â€” value = hour of day</li>
 * </ul>
 */
